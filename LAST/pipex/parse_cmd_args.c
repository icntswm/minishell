...
/*   Updated: 2021/11/05 01:51:55 by fkenned          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../minishell.h"

static char	**fill_args2(char *s, char **strs, t_parser_info info)
{
	while (s[info.end])
	{
		info.start = info.end;
...
static char	**fill_args(char *s, char **strs)
{
	t_parser_info	info;
